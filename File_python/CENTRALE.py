...
"""scale"""
scala_corte1=T([1,2,3])([42.021965093729804+19.84314156431803-7, -27.53058177117001-5.29082740788623,10.4])(createSteps(20,[0.27,5.29082740788623/2,0.15],full=True))
scala_corte2=T([1,2,3])([42.021965093729804+7, -27.53058177117001-5.29082740788623,10.4])(S(1)(-1)(createSteps(20,[0.27,5.29082740788623/2,0.15],full=True)))
scala_corte3=T([1,2,3])([42.021965093729804+1.6, -27.53058177117001-5.29082740788623/2,13.4])(createSteps(20,[0.27,5.29082740788623/2,0.15],full=True))
scala_corte4=T([1,2,3])([42.021965093729804+19.84314156431803-1.6, -27.53058177117001-5.29082740788623/2,13.4])(S(1)(-1)(createSteps(20,[0.27,5.29082740788623/2,0.15],full=True)))
...
VIEW(STRUCT([pianerottolo,scala_corte1,scala_corte2,scala_corte3,scala_corte4,centro]))
